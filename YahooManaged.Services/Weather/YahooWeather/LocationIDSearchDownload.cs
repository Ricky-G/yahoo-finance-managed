...
namespace YahooManaged.Services.Weather.YahooWeather
{
    ...
    public partial class LocationIDSearchDownload : DownloadClient<LocationIDSearchResult>
    {
        ...
        public void DownloadAsync(string keyword, YahooManaged.IResultIndexSettings opt, object userArgs)
        {
        ...
        protected override LocationIDSearchResult ConvertResult(YahooManaged.Base.ConnectionInfo connInfo, System.IO.Stream stream, YahooManaged.Base.SettingsBase settings)
        {
    ...
    public class LocationIDSearchDownloadSettings : SettingsBase, IResultIndexSettings
    {
