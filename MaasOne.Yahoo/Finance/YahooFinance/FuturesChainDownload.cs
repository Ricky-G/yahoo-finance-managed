...
namespace YahooManaged.Services.Finance.YahooFinance
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public partial class FuturesChainDownload : DownloadClient<FuturesResult>
    {
        ...
        protected override FuturesResult ConvertResult(YahooManaged.Base.ConnectionInfo connInfo, System.IO.Stream stream, YahooManaged.Base.SettingsBase settings)
        {
    ...
    public class FuturesChainDownloadSettings : SettingsBase
    {
